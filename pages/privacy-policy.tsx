  ...
  return (
    <div className="relative mb-16">
      ...
      <div className="min-h-screen px-6 relative z-10 md:px-0 md:justify-center max-w-[98%] lg:max-w-[93%] pt-8 md:pl-16">
        <div className="">
          <h1 className="text-skin-globalGreen text-2xl font-semibold md:text-4xl md:font-bold pb-8 ">
            <u>Privacy Policy</u>
          </h1>
          <p className="my-4">
            At ClueLess, accessible from{' '}
            <a
              href="https://clueless.live"
              className="underline text-skin-main"
            >
              clueless.tech
            </a>
            , one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is
            collected and recorded by ClueLess and how we use it.
          </p>
          ...
          <p className="my-4">
            ...
            that they shared and/or collect in ClueLess. This policy is not
          ...
          <p className="my-4">
            ClueLess follows a standard procedure of using log files. These
          ...
          <p className="my-4">
            ...
            advertising partners of ClueLess.
          </p>
          ...
          <p className="my-4">
            ...
            respective advertisements and links that appear on ClueLess, which
          ...
          <p className="my-4">
            Note that ClueLess has no access to or control over these cookies
          ...
          <p>
            ClueLess does not knowingly collect any Personal Identifiable
