...
const addProject: NextPage = () => {
  ...
  return (
    <div>
      <Head>
        <title>ClueLess | Add Projects</title>
      </Head>
      <Navbar />
      <Sidebar
        img={"/addProject.png"}
        title={"One Step Closer to my Dream✨"}
      />
      <form
        action=""
      ...
      >
        <div className="grid grid-cols-2 gap-0 md:gap-6 lg:gap-10">
          <div className="col-span-2 xl:col-span-1 mt-10">
            <h1 className="xl:hidden text-3xl font-semibold mb-10 mt-5 md:mb-10 text-center sm:text-left">✨ Add Projects ✨</h1>
            <div className="my-3">
              <TextField
                id="outlined-basic"
          ...
          <div className="col-span-1 mt-10  items-center justify-center hidden xl:flex">
            <h1 className="text-4xl font-semibold">✨ Add Projects ✨</h1>
          </div>
        </div>
