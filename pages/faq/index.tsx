      ...
      <div>
        ...
        <div className="w-4/5 m-auto">
          <h1 className="font-raleway text-[28px] md:text-[36px] font-semibold leading-normal my-3 md:text-[28]">
            Having Questions?
            <span className="font-raleway text-skin-main">
              {' '}
              Try finding them below{' '}
            </span>
            :
          </h1>
          <p className="leading-6 text-sm md:text-base my-5">
            Below you’ll find answers to the most common questions you may have
            on ClueLess. If you still can’t find the answer you’re looking for,
            just Contact us!
          </p>
            ...
            >
              ...
              <AccordionDetails className="dark:bg-[#17202A]">
                <Typography>
                  ...
                  motive of “Learn and Grow”. We, as a community, encourage and
                  guide enthusiasts to dive into the world of open-source. We
                  provide the best resources available on the internet, write
                  blogs that helps other to explore their domain more deeply,
                  organize events, GitHub repositories, organize hackathons, and
                  more couniting activities.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              <AccordionDetails className="dark:bg-[#17202A]">
                <Typography>
                  ...
                  confused and clueless. So we, the Clueless Community provide
                  the best, filtered, and curated resources like YouTube videos,
                  GitHub repositories, websites, cheatsheets, etc!
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
            ...
            >
              ...
              <AccordionDetails className="dark:bg-[#17202A]">
                <Typography>
                  ...
                  interact with other audiences, ask and help others. There are
                  different channels for every tech domain.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion
