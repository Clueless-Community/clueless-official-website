  ...
  return (
    <>
      <div className="hidden lg:block ">
        <div className="w-[300px] h-screen shadow-xl bg-sidebar-pattern text-center bg-skin-main px-10 float-left relative flex justify-center">
          <h1 className="font-extrabold text-4xl text-center mt-28 text-white">
            {title}
          </h1>
          <div className="absolute bottom-10 h-[239px]">
            <img src={img} alt="" />            
          </div>
        </div>
      </div>
