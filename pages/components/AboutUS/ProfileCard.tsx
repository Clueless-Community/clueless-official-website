    ...
    return(
        <div className="flex flex-col h-96 w-72 items-center py-7 px-5 border-2 border-dashed rounded-xl border-black border-opacity-30 hover:scale-110 ease-in-out duration-300" key={key}>
            ...
            <div className="mt-8 w-4/5 flex justify-between">
                <a href={github} target="_blank" rel="noreferrer" className="hover:text-[#1955CA]"><GitHubIcon/></a>
                <a href={linkedin} target="_blank" rel="noreferrer" className="hover:text-[#1955CA]"><LinkedInIcon/></a>
                <a href={twitter} target="_blank" rel="noreferrer" className="hover:text-[#1955CA]"><TwitterIcon/></a>
            </div>
        </div>
    )
