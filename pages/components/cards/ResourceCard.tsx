        ...
        <div className="absolute bottom-0 w-full">
          <div className="flex mb-2 space-x-2">
            <div className="flex item-center text-skin-hoverBlue font-semibold ">
              ...
              <p className="ml-2 my-auto font-semibold text-sm ">
                {specificStack}
              </p>
            </div>
            <div className="flex item-center text-skin-hoverBlue font-semibold">
          ...
          <button className="w-full btn-blue py-2 flex justify-center items-center">
            <RemoveRedEyeIcon className="w-[15px] my-auto" />{' '}
            <span className="my-auto ml-2">View</span>
          </button>
        </div>
      </div>
    </div>
