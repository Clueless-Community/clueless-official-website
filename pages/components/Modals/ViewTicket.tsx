...
const ViewTicket: React.FC<Props> = ({
  ...
  return (
    <div>
      <button onClick={handleOpen} className="btn-blue">
        View Ticket
      </button>
      <Modal
        open={open}
          ...
          <div className="flex flex-col-reverse xl:flex-row">
            <div className="hidden md:flex flex-col justify-center items-center space-y-4 border-dashed xl:border-r-2 border-[#989797] p-4 md:p-8 xl:pr-16">
              ...
              <p className="text-sm text-gray-400 text-center">
                Scan this QR code for the entry in the venue
              </p>
            </div>
            <div className="w-full p-4 md:p-8 space-y-6">
              <div className="flex flex-col-reverse md:flex-row justify-between space-y-6 md:space-y-0">
                <div className="flex flex-col">
                  <p className="text-center md:text-left text-sm text-gray-400 mt-4 md:mt-0">
                    Token No.
                  </p>
                  <p className="text-center md:text-left text-[10px] text-gray-400 max-w-fit mx-auto break-all">
                    {tokenNo}
                  </p>
                </div>
                <div className="text-center">
                  <p className="text-2xl text-gray-400">TICKET</p>
                  <h1 className="text-[#1955CA] font-poppins text-4xl md:text-5xl">
                    {eventName}
                  </h1>
                </div>
                <img
              ...
              <div className="justify-between mx-auto w-[90%] flex flex-col sm:flex-row">
                ...
                <img
                  src={eventLogo}
                  className="w-[50%] h-[160px] border-dashed border-2 border-[#989797] rounded-lg hidden md:block"
                />
