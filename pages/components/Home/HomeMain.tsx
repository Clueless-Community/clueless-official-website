...
import lottiefile from './37050-get-in-touch-with-us-online-managers.json'
const HomeMain = () => {
    ...
    return (
        ...
        <div className='lg:grid xl:grid-cols-2 xl:mx-40 mt-8 flex flex-col w-10/12 mx-auto lg:text-left md:py-28 pt-16' id="home">
            <div>
