...
const TeamMembersHome = () => {
  return (
    <div className="sm:mb-44 mt-20">
      <h2 className="xl:px-28 lg:px-20 w-11/12 text-center  text-4xl font-semibold">
      ...
      <div className=" mx-auto justify-center flex-wrap hidden lg:flex">
        <Link href="/about-us" passHref>
          <AvatarGroup
            max={12}
            className="2xl:scale-[370%] xl:scale-[300%] lg:scale-[230%] mt-32"
          >
            <Tooltip title="Rajdeep Sengupta" arrow>
              <Avatar
                alt="Remy Sharp"
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Rajdeep.png"
              />
            </Tooltip>
            ...
            <Tooltip title="Sayan Chowdhury" arrow>
              <Avatar
                ...
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Sayan Chowdhury.jpg"
              />
            </Tooltip>
            <Tooltip title="Nikhil Raj" arrow>
              <Avatar
                ...
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Nikhil Raj.jpg"
              />
            </Tooltip>
            ...
            <Tooltip title="Subho Ghosh" arrow>
              <Avatar
                ...
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Subho Ghosh.jpg"
              />
            </Tooltip>
            <Tooltip title="Kingshuk Sarkar" arrow>
              <Avatar
                ...
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Kingshuk Sarkar.jpeg"
              />
            </Tooltip>
            <Tooltip title="Kusumita Ghose" arrow>
              <Avatar
                ...
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Kusumita Ghose.jpg"
              />
            </Tooltip>
            <Tooltip title="Jyothi Swaroop Makena" arrow>
              <Avatar
                ...
                sx={{ maxWidth: 150, maxHeight: 150 }}
                className="ring-1 border-[#1955CA] hover:scale-110 transition-all cursor-pointer hover:z-50 relative"
                src="/TeamMembers/Jyothi Swaroop.jpg"
              />
            </Tooltip>
      ...
      <div className=" mx-auto justify-center flex-wrap flex-col items-center py-12 flex lg:hidden">
        <AvatarGroup
          max={12}
          className="sm:scale-[250%] scale-150 sm:py-16 py-6"
        >
          <Avatar
            alt="Remy Sharp"
            sx={{ maxWidth: 150, maxHeight: 150 }}
      ...
      <div className="flex justify-center">
        <Link href="/about-us" passHref>
          <button className="btn-blue mx-auto lg:hidden">
            Know More about Us
          </button>
        </Link>
      </div>
