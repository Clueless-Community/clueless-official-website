  ...
  return (
    ...
    <div className='flex justify-between px-5 sm:px-40 bg-skin-main pt-10 mt-10 flex-col lg:flex-row'>
        <div className='my-auto pb-10 text-center lg:text-left'>
            ...
            <a href="https://www.buymeacoffee.com/forclueless" target="_blank" rel="noreferrer">
            <button className='btn-blue bg-white hover:bg-gray-200 mt-8 md:text-2xl flex items-center text-gray-800 mx-auto lg:mx-0 text-xl'><VolunteerActivismIcon className='mr-2 text-3xl'/>Donate</button>
            </a>
        </div>
