  ...
  return (
    <div className="md:w-[550px] h-[470px] bg-gradient-to-r from-black via-blue-1000 to-blue-800 rounded-2xl p-[57px]">
      ...
      <div className="space-y-12">
        <p className="text-white text-md md:text-lg md:font-light	">
          {description}
        </p>
      ...
      <Link href={`${repoUrl}`} passHref>
        <a
          target="_blank"
          className="flex justify-center items-center mt-10 px-12 py-2 md:py-4 bg-gray-200 text-black font-bold text-xl md:text-2xl hover:bg-gray-100 hover:scale-105 hover:ease-in-out transition hover:duration-300 rounded-2xl"
        >
