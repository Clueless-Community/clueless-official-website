...
const RewardsAndPerks = () => {
  return (
    <div>
      ...
      <div className="space-x-5 space-y-3 md:grid lg:grid-cols-2 m-10 md:mx-40 flex flex-col text-center lg:text-left pb-10 px-[20px] sm:px-[91px]">
        <img src="/rewards.png" className="mx-auto md:mx-0" />
        <div className="ml-30 pt-20 py-auto">
