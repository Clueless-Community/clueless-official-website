...
const Guidelines = () => {
  return (
    <div className="">
      <h1 className="text-center text-[24px] lg:text-3xl xl:text-4xl">
        Guidelines ✅
      </h1>
      <div className="space-x-5 space-y-3 md:grid lg:grid-cols-2 m-10 md:mx-40 flex flex-col text-center lg:text-left py-[28px] px-[20px] sm:px-[91px]">
        <div className="">
          ...
          <a
            href="https://github.com/Clueless-Community/clueless-official-website/blob/main/CODE_OF_CONDUCT.md"
            target="_blank"
            rel="noreferrer"
          >
        ...
        <img src="/guidelines.png" alt="..." className="mx-auto md:mx-0" />
      </div>
    </div>
  );
};
