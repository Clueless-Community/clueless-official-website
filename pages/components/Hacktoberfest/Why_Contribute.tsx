...
const Why_Contribute = () => {
    return (
        <div className='bg-gradient-to-r from-black via-black to-neutral-400  mx-10 mt-10 mb-20 md:mx-40 flex flex-col text-center lg:text-left rounded-3xl py-[28px] px-[40px] sm:px-[91px] space-y-7'>
            <h1 className='text-[24px] text-white text-center lg:text-3xl xl:text-4xl'>Why You Should Contribute?</h1>
