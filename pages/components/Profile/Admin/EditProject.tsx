        ...
        <>
            ...
            >
                <Box sx={style}>
                    ...
                    <Box sx={{
                        display: "flex", justifyContent: 'space-between', mt: 2, [theme.breakpoints.down('sm')]: {
                            flexDirection: 'column',
                        },
                    }}>
                        <label
                            htmlFor="file-upload"
                            className=" cursor-pointer w-80 h-52 relative"
                        >
                    ...
                    <button className='btn-red mt-5 float-right px-6 py-2 shadow-red-600 mr-5'>Discard</button>
                </Box>
            </Modal>
        </>
    );
