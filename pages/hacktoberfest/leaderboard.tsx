    ...
    return (
        <div className=''>
            ...
            <div className='xl:my-20 my-4 md:mx-40 sm:mx-4 mx-1'>
                ...
                <p className='my-1.5 sm:my-3 text-center'>Leaderboard will be updated everyday. Checkout the Points System <a href='https://clueless-resources.super.site/hacktoberfest/how-points-are-calculated' target='_blank' rel="noreferrer" className='text-blue-600 hover:underline'>here</a>.</p>
