...
const AddEvent: React.FC = () => {
  ...
  const validatePublish = () => {
    if (
      selectedFileBannerImage.length === 0 ||
      date === null ||
      selectedFileIconImage.length === 0 ||
      mediaBannerImage! === undefined ||
      mediaIconImage! === undefined ||
      venuename.length === 0 ||
      eventname.length === 0 ||
      timeperiod.length === 0 ||
      Object.values(inputListAgenda).every((value) => '') ||
      Object.values(inputListSpeakers).every((value) => '')
    )
      return true;
    else return false;
  };
              ...
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="space-y-2 col-span-1 md:col-span-2">
                      ...
                      <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-600">
                          ...
                          <input
                            ...
                            accept="image/*"
                            onChange={(e) => {
                              setMediaBannerImage(e?.target?.files![0] as File);
                  ...
                  <div>
                    {validatePublish() ? (
                      <button
                        className="py-3 px-2 font-bold  text-black  bg-gray-200 text-sm rounded-md mt-6 cursor-not-allowed"
                        disabled
                      >
                        Publish
                      </button>
                      ...
                      <button
                        className="py-3 px-2 font-bold  text-green-800  bg-green-200 text-sm rounded-md hover:bg-green-400 hover:shadow-xl mt-6"
                        onClick={addEvent}
                      >
                        Publish
                      </button>
