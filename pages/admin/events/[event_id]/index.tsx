...
const AddEvent: React.FC = () => {
  ...
  const [selectedFileBannerImage, setSelectedFileBannerImage] =
    useState<string>('');
  const [selectedFileIconImage, setSelectedFileIconImage] =
    useState<string>('');
  ...
  const [inputListSpeakers, setInputListSpeakers] = useState([
    { name: '', image: '', linkedinUrl: '', gitHubURL: '', twitterURL: '' },
  ]);
  const [inputListWinners, setInputListWinners] = useState([
    { name: '', imageURL: '' },
  ]);
  ...
  useEffect(() => {
    ...
    setInputListWinners(eventData?.winners),
      setPresent(eventData?.present),
      present
        ? setPresentForm('Event Not done yet')
        : setPresentForm('Event Done');
  }, [eventData]);
  ...
  const handleBannerImageUpload = async () => {
    ...
    const bannerImageRef = ref(
      storage,
      `event/${date.getTime()}_bannerImage.jpg`
    );

    const uploadTask =
      mediaBannerImage &&
      uploadBytesResumable(bannerImageRef, mediaBannerImage);
    uploadTask &&
      uploadTask.on(
        'state_changed',
        (snapshot: {
  ...
  const handleIconImageUpload = async () => {
    ...
    const uploadTask =
      mediaIconImage && uploadBytesResumable(IconImageRef, mediaIconImage);
    uploadTask &&
      uploadTask.on(
        'state_changed',
        (snapshot: {
  ...
  const validatePublish = () => {
    if (
      ...
      venuename === '' ||
      inputListSpeakers.length === 0 ||
      !inputListSpeakers.every(
        (item) =>
          (item.name && item.image && item.linkedinUrl && item.twitterURL) ||
          item.gitHubURL
      ) ||
      !inputListAgenda.every((item) => item.description && item.time) ||
      !inputListWinners.every((item) => item.name && item.imageURL) ||
      date === null ||
      timeperiod === '' ||
      attraction === ''
    ) {
          ...
          {eventData?.length !== 0 ? (
            <div>
              ...
              <div className="mx-auto text-xl mt-11 mb-10 w-10/12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3">
                    <div className="space-y-2 col-span-1 md:col-span-2">
                          ...
                          <div className="space-y-1 text-center">
                            {selectedFileBannerImage ? (
                              <img
                                ...
                                alt=""
                                className="w-full h-full object-cover mx-auto my-3"
                              />
                            ) : (
                              <svg
                      ...
                      <div>
                        ...
                        <div className="space-y-4">
                          {inputListSpeakers?.map(
                            (item: instructorOrspeaker, i: number) => {
                              return (
                                <div className="" key={i}>
                                  <button className="w-full flex items-center justify-end py-2">
                                    {' '}
                                    <MdRemoveCircleOutline
                                      className="text-3xl"
                                      onClick={() => {
                          ...
                          <span className="space-x-2 flex justify-end">
                            <button className="w-full pb-4">
                              <div className="w-full flex justify-end">
                                <button
                                  onClick={() => handleAddClickSpeakers()}
                                  className=""
                                >
                      ...
                      <div className="space-y-2">
                          ...
                          return (
                            <div className="" key={i}>
                              ...
                              >
                                ...
                                <span className="space-x-2 flex justify-end">
                                  {inputListAgenda.length > 0 && (
                                    <button
                                      onClick={(e) => {
                                        setDeleteIndexAgenda(i), handleOpen2();
                                      }}
                                    >
                        ...
                        <FormControl fullWidth className="mt-6">
                          ...
                          <Select
                            ...
                            label="Event Type"
                            onChange={(e) => {
                              setPresentForm(e.target.value);
                              presentForm === 'Event Not done yet'
                                ? setPresent(false)
                                : setPresent(true);
                            }}
                          >
                            <MenuItem value="Event Done">Event Done</MenuItem>
                            <MenuItem value="Event Not done yet">
                              Event Not done yet
                            </MenuItem>
                          </Select>
                        </FormControl>
                                ...
                                <div key={index}>
                                  <div className="col-span-1 mr-1 mt-2 flex gap-4  items-start">
                                    <TextField
                                      ...
                                      placeholder={`Enter Name of Winner ${
                                        index + 1
                                      }`}
                                      value={item.name}
                                      multiline
                                    ...
                                    <TextField
                                      ...
                                      placeholder={`Enter imageURL of Winner ${
                                        index + 1
                                      }`}
                                      value={item.imageURL}
                                      multiline
                                    ...
                                    />
                                    <div>
                                      {inputListWinners.length > 0 && (
                                        <button
                                          onClick={(e) =>
                                            handleRemoveWinners(e, index)
                                          }
                                        >
                      ...
                      <div>
                        {!validatePublish() ? (
                          <button
                            className=" btn-blue bg-zinc-400 hover:bg-zinc-400 cursor-not-allowed"
                            disabled
                          >
                            Publish
                          </button>
                          ...
                          <button
                            className="bg-green-600 hover:bg-green-700 btn-blue  hover:shadow-xl"
                            onClick={handleOpen3}
                          >
                            Publish
                          </button>
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="space-x-12 w-full flex justify-center">
                      <button
                        onClick={(e) => {
                          handleRemoveSpeakers(e, deleteIndex);
                        }}
                        className="btn-blue"
                        autoFocus
                      >
                ...
                >
                  <div className="p-6">
                    ...
                    <div className="space-x-12 w-full flex justify-center">
                      <button
                        onClick={(e) => {
                          handleRemoveAgenda(e, deleteIndexAgenda);
                        }}
                        className="btn-blue"
                        autoFocus
                      >
                ...
                <button
                  className="btn-blue fixed z-100 right-8 bottom-8 "
                  onClick={() => router.push(`/events/${eventData?.event_id}`)}
                >
                  View Event
                </button>
              </div>
