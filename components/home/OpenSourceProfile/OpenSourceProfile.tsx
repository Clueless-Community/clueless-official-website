    ...
    <div className="relative">
      ...
      <div className="flex flex-col relative z-10 lg:flex-row items-center w-full justify-between">
        <div className=" w-full lg:w-1/2">
          ...
          <h1 className="text-white text-3xl font-semibold sm:text-3xl sm:font-semibold  md:text-5xl md:font-bold  mt-1">
            Open-source Profile
          </h1>
          <br />
          <p className="text-[20px] sm:text-[25px] text-yellow-50">
          ...
          <br />
          <Link href="/">
            <div className="text-skin-globalGreen text-[17px] flex justify-start cursor-pointer items-center">
      ...
      <div className="flex items-center justify-center pt-3">
        <img
          className=" w-[70vw] hidden rotate-180 items-center justify-center sm:block md:w-[35vw] md:block"
          src="true-design.png"
          alt=""
        />
        <img
